...
public class LibraryResourceUtils {

    private static Iterable<org.hl7.fhir.r4.model.Library> getLibrariesByName(LibraryResourceProvider provider, String name) {
    ...
    private static Iterable<org.hl7.fhir.r4.model.Library> resolveLibraries(List< IBaseResource > resourceList) {
    ...
    public static org.hl7.fhir.r4.model.Library resolveLibraryById(LibraryResourceProvider provider, String libraryId) {
        try {
    ...
    public static org.hl7.fhir.r4.model.Library resolveLibraryByName(LibraryResourceProvider provider, String libraryName, String libraryVersion) {
        org.hl7.fhir.r4.model.Library library = null;
        org.hl7.fhir.r4.model.Library maxVersion = null;

        Iterable<org.hl7.fhir.r4.model.Library> libraries = getLibrariesByName(provider, libraryName);
        for (org.hl7.fhir.r4.model.Library l : libraries) {

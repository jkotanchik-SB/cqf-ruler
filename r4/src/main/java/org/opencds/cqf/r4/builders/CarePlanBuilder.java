...
public class CarePlanBuilder extends BaseBuilder<CarePlan> {
    ...
    public CarePlanBuilder buildDefinition(List<Reference> references) {
        complexProperty.setInstantiatesCanonical(references.stream().map(x -> new CanonicalType(x.getReference())).collect(Collectors.toList()));
        return this;
    }
    ...
    public CarePlanBuilder buildDefinition(Reference reference) {
        ...
        complexProperty.addInstantiatesCanonical(reference.getReference());
        return this;
    }

...
public class CarePlanActivityDetailBuilder extends BaseBuilder<CarePlan.CarePlanActivityDetailComponent> {
    ...
    public CarePlanActivityDetailBuilder buildKind(String kind) {
        complexProperty.setKind(CarePlan.CarePlanActivityKind.fromCode(kind));
        return this;
    }

    public CarePlanActivityDetailBuilder buildInstantiatesCanonical(Reference reference) {
        complexProperty.setInstantiatesCanonical(Collections.singletonList(new CanonicalType(reference.getReference())));
        return this;
    }
    ...
    public CarePlanActivityDetailBuilder buildStatusReason(String reason) {
        complexProperty.setStatusReason(new CodeableConcept().addCoding(new Coding().setCode(reason)));
        return this;
    }

    public CarePlanActivityDetailBuilder buildDoNotPerform(boolean prohibited) {
        complexProperty.setDoNotPerform(prohibited);
        return this;
    }

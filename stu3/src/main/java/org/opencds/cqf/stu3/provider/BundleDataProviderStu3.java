...
import org.opencds.cqf.stu3.utils.DataProviderUtils;

import java.util.*;

public class BundleDataProviderStu3 extends JpaDataProvider {
        ...
        for (Object resource : resourcesOfType) {
            ...
            if (dateRange != null) {
                if (datePath != null) {
                    ...
                    Object dateObject = DataProviderUtils.getStu3DateTime(resolvePath(resource, datePath));
                    ...
                    String precision = DataProviderUtils.getPrecision(Arrays.asList(dateRange, date));
                    ...
                    DateTime lowDate = dateLowPath == null ? null : (DateTime) DataProviderUtils.getStu3DateTime(resolvePath(resource, dateLowPath));
                    DateTime highDate = dateHighPath == null ? null : (DateTime) DataProviderUtils.getStu3DateTime(resolvePath(resource, dateHighPath));

                    String precision = DataProviderUtils.getPrecision(Arrays.asList(dateRange, lowDate, highDate));
            ...
            if (codePath != null && !codePath.equals("") && includeResource) {
                ...
                if (codes != null) {
                    Object codeObject = DataProviderUtils.getStu3Code(resolvePath(resource, codePath));
                    includeResource = DataProviderUtils.checkCodeMembership(codes, codeObject);
                }

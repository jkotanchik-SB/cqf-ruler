...
import org.opencds.cqf.stu3.utils.DataElementType;
...
public class DataRequirementsProvider {
    ...
    public CqfMeasure createCqfMeasure(Measure measure, Collection<Library> libraries, LibraryResourceProvider libraryResourceProvider)
    {
        ...
        String primaryLibraryName = LibraryResourceUtils.resolveLibraryById(libraryResourceProvider, primaryLibraryId).getName();
        ...
        for (Library library : libraries) {
            ...
            org.hl7.fhir.dstu3.model.Library libraryResource = LibraryResourceUtils.resolveLibraryByName(
            ...
            if (library.getCodeSystems() != null && library.getCodeSystems().getDef() != null) {
                for (CodeSystemDef codeSystem : library.getCodeSystems().getDef()) {
                    ...
                    CqfMeasure.TerminologyRef term = new CqfMeasure.VersionedTerminologyRef(CqfMeasure.TerminologyRef.TerminologyRefType.CODESYSTEM, name, id, version);
            ...
            if (library.getValueSets() != null && library.getValueSets().getDef() != null) {
                for (ValueSetDef valueSet : library.getValueSets().getDef()) {
                    ...
                    CqfMeasure.TerminologyRef term = new CqfMeasure.VersionedTerminologyRef(CqfMeasure.TerminologyRef.TerminologyRefType.VALUESET, name, id);
                    Boolean exists = false;
        ...
        Comparator terminologyRefComparator = new Comparator<CqfMeasure.TerminologyRef>() {
            @Override
            public int compare(CqfMeasure.TerminologyRef item, CqfMeasure.TerminologyRef t1) {
    ...
    public org.hl7.fhir.dstu3.model.Library getDataRequirements(Measure measure, Collection<Library> libraries, LibraryResourceProvider libraryResourceProvider){
    ...
    public CqlTranslator getTranslator(org.hl7.fhir.dstu3.model.Library library, LibraryManager libraryManager, ModelManager modelManager) {
        ...
        CqlTranslator translator = TranslatorUtil.getTranslator(
            ...
            for (org.hl7.elm.r1.IncludeDef def : elm.getIncludes().getDef()) {
                library.addRelatedArtifact(new RelatedArtifact().setType(RelatedArtifact.RelatedArtifactType.DEPENDSON)
                        .setResource(new Reference().setReference(
                                LibraryResourceUtils.resolveLibraryByName(libraryResourceProvider, def.getPath(), def.getVersion()).getId())));
            }
        }
